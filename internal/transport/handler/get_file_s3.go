...
func GetFile(w http.ResponseWriter, r *http.Request) {
	...
	request, err := http.NewRequest("GET", "https://127.0.0.1:8443/download-file?filename="+filename+"&username="+username, nil)
	if err != nil {
	...
	// Установка правильного заголовка Content-Type для отображения в браузере
